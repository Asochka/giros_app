 ...
 * Use the [FragmentPayMethod.newInstance] factory method to
 * create an instance of this fragment.
 */
class FragmentPayMethod : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentPayMethod.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentPayMethod().apply {
